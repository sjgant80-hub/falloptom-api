...
HTTP API wrapping `@ai-native-solutions/falloptom-sdk`.
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-api](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-api)
...
- **Companion SDK** (`npm install @ai-native-solutions/falloptom-api-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falloptom-api -- npx -y @ai-native-solutions/falloptom-api-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falloptom-api-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-api
- **Live URL**: https://sjgant80-hub.github.io/falloptom-api/
- **Source**: https://github.com/sjgant80-hub/falloptom-api
